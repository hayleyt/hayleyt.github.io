...
function Weather() {
   return(
      <article className="project-page">
         ...
         <a href="https://hayleyt.github.io/weather-app/">
         ...
         <div className="lists">
            ...
            <div className="list">
               ...
               <ul>
                  ...
                  <li><strong>API: </strong><a href="https://openweathermap.org/">openweathermap.org</a></li>
                  <li><strong>Module bundler: </strong>Webpack</li>
                  <li><strong>Deployment: </strong>Github pages</li>
                  <li>
                     <strong>Source code: </strong>
                     <a href="https://github.com/hayleyt/weather">github.com/hayleyt/weather</a>
                  </li>
               </ul>
            </div>
         </div>
